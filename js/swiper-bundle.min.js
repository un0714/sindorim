...
!(function (e, t) {
  ...
  function M(e) {
    ...
    if (!s.allowTouchMove)
      return (s.allowClick = !1), void (i.isTouched && (Object.assign(n, { startX: h, startY: m, currentX: h, currentY: m }), (i.touchStartTime = u())));
          ...
          for (let i = 0; i < p; i += 1) {
            ...
            if ((C && e.grid.updateSlide(i, n, p, t), 'none' !== n.css('display'))) {
              if ('auto' === a.slidesPerView) {
                ...
                ($ = (r - (a.slidesPerView - 1) * x) / a.slidesPerView), a.roundLengths && ($ = Math.floor($)), c[i] && (c[i].style[t('width')] = `${$}px`);
  ...
  const J = [
    ...
    function ({ swiper: e, extendParams: t, on: s, emit: a }) {
      ...
      function c() {
        ...
        if (
          ('fraction' === s.type && (c.find(W(s.currentClass)).text(s.formatFractionCurrent(p + 1)), c.find(W(s.totalClass)).text(s.formatFractionTotal(u))),
          'progressbar' === s.type)
        ) {
          let t;
                ...
                if (i.freeMode.momentum) {
                  ...
                  if (c < e.maxTranslate())
                    i.freeMode.momentumBounce
                      ? (c + e.maxTranslate() < -m && (c = e.maxTranslate() - m), (p = e.maxTranslate()), (h = !0), (o.allowMomentumBounce = !0))
                      : (c = e.maxTranslate()),
                      i.loop && i.centeredSlides && (f = !0);
                  else if (c > e.minTranslate())
                    i.freeMode.momentumBounce
                      ? (c - e.minTranslate() > m && (c = e.minTranslate() + m), (p = e.minTranslate()), (h = !0), (o.allowMomentumBounce = !0))
                      : (c = e.minTranslate()),
                      i.loop && i.centeredSlides && (f = !0);
        ...
        (e.grid = {
          ...
          updateSlide: (t, r, n, l) => {
            ...
            if ('row' === p && o > 1) {
              ...
              'column' === p
                ? ((h = Math.floor(t / c)), (m = t - h * c), (h > i || (h === i && m === c - 1)) && ((m += 1), m >= c && ((m = 0), (h += 1))))
